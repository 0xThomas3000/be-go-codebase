...
import (
	...
	"github.com/0xThomas3000/be-go-codebase/api/utils/fileformat"
...
/*
- We sent a photo upload to either DigitalOceanSpaces or AWS S3 Bucket
- Will need to create an Amazon S3 bucket or DigitalOcean Spaces object to store the images.
*/
