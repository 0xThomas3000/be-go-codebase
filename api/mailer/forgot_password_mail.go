...
/*
  - Remember when we were wiring up the models, we had the ResetPassword model.
    Well, when a user wishes to change his password, an email is sent to him with instructions to do so.
    Let set up that email file (the emails are handled using Sendgrid service.)
*/
